---
title: "Đăng nhập hệ thống bằng tài khoản được cấp"
description: "Tài khoản được cấp bởi Quản Lý Hệ Thống "
---
...
Mỗi cá nhân thuộc bộ phận quản lý hoặc người dùng sẽ được cấp một tài khoản chịu trách nhiệm
